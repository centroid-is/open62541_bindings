...
void clientIsolate(SendPort mainSendPort) async {
  ...
  try {
    NodeId objectId = NodeId.string(4, "GVL_IO.domeLightGreen");
    NodeId methodId = NodeId.string(4, "GVL_IO.domeLightGreen#force");
    final data =
        await c.call(objectId, methodId, [true], [TypeKindEnum.boolean]);
